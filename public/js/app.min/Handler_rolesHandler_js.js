...
function crearRol() {
  ...
  submitButton.on('click', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
      var roleName, roleDescription, requestBody, response, errorsText, responseDataText;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            event.preventDefault();
            roleName = $('#rol').value();
            roleDescription = $('#descripcion').value();
            _context.prev = 3;
            requestBody = {
              nameType: roleName,
            ...
            _context.next = 7;
            return api.post('tipoUsuario/registrar', requestBody);
          case 7:
            response = _context.sent;
            if (response.isError) {
              // Manejo de errores específicos de la API
              console.error('Error al crear el rol:', response.message);
              errorsText = JSON.stringify(response.errors, null, 2);
              modal.openModal('informative', {
                status: false,
              ...
              responseDataText = JSON.stringify(response.data, null, 2);
              modal.openModal('informative', {
                status: true,
                title: response.message,
                msg: responseDataText
              });
            }
            _context.next = 15;
            break;
          case 11:
            ...
            console.error('Error al crear el rol:', _context.t0);
            modal.openModal('informative', {
              status: false,
              msg: _context.t0.message || 'Error al procesar la solicitud.'
            });
          case 15:
          case "end":
