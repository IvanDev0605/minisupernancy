...
var RouteController = /*#__PURE__*/function () {
  ...
  _createClass(RouteController, [{
    ...
    value: function handleMenuClick(action) {
      ...
      var targetRoute = "/views/pages/".concat(entity, "/").concat(operation, ".html");
    ...
    value: function loadView() {
      var targetRoute = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : window.location.pathname;
      var cleanURL = arguments.length > 1 ? arguments[1] : undefined;
      var _targetRoute$split = targetRoute.split('/'),
        _targetRoute$split2 = _slicedToArray(_targetRoute$split, 3),
        _ = _targetRoute$split2[0],
        entity = _targetRoute$split2[1],
        operation = _targetRoute$split2[2];
      targetRoute = "/views/pages/".concat(entity, "/").concat(operation, ".html");
    ...
    key: "fetchAndRender",
    value: function fetchAndRender(viewPath, cleanURL) {
      var _this = this;
      fetch(viewPath).then(function (response) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              throw new Error("POST request failed: ".concat(response.statusText));
            case 8:
              _context.next = 10;
              return response.json();
            case 10:
